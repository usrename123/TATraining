...
public class SFDC {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		logger.log(LogStatus.PASS, " My Login TC 1 passed " + logger.addScreenCapture(takeScreenshot()));
		...
		driver.findElement(By.xpath("//input[@id='Login']")).click();
		Thread.sleep(2000L);
		logger.log(LogStatus.PASS, "User menu is  opened" + logger.addScreenCapture(takeScreenshot()));
		Thread.sleep(4000L);
		...
		logger.log(LogStatus.PASS, "My Test TC4 is passed " + logger.addScreenCapture(takeScreenshot()));
		...
		logger.log(LogStatus.PASS, "TC4B is success"+logger.addScreenCapture(takeScreenshot()));
			reports.endTest(logger);
		driver.close();
		reports.flush();
		Thread.sleep(3000L);
